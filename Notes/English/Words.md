...
| 日期 | 单词 | 音标 | 释义 | 常用搭配 | 例句 |
|:---:|:---:|:---|:---|:---|:---|
| 2026-09-03 | persist (复现) | /pərˈsɪst/ | v. 坚持，执意；持续 | persist in 坚持 | If you **persist**, you will succeed. |
| | mutual (复现) | /ˈmjuːtʃuəl/ | adj. 相互的，共同的 | mutual respect 相互尊重 | They have **mutual** trust. |
| | vague (复现) | /veɪɡ/ | adj. 模糊的，含糊的 | vague idea 模糊的想法 | He gave a **vague** answer. |
| | anecdote (复现) | /ˈænɪkdoʊt/ | n. 轶事，趣闻 | tell an anecdote 讲趣闻 | He told us an amusing **anecdote**. |
| | kin (复现) | /kɪn/ | n. 亲属，家人（总称） | next of kin 直系亲属 | We must inform the next of **kin**. |
| | lucrative (复现) | /ˈluːkrətɪv/ | adj. 赚钱的，利润丰厚的 | lucrative business 赚钱的生意 | He landed a **lucrative** job. |
| | crude (复现) | /kruːd/ | adj. 粗糙的；原油的；粗鲁的 | crude oil 原油 | The pipeline transports **crude** oil. |
| | boast (复现) | /boʊst/ | v. 自夸，吹嘘；以拥有…自豪 | boast about 吹嘘 | He **boasted** about his achievements. |
| | gown (复现) | /ɡaʊn/ | n. 长袍，礼服；（手术）罩衣 | evening gown 晚礼服 | She wore an evening **gown**. |
| | imminent (复现) | /ˈɪmɪnənt/ | adj. 临近的，迫在眉睫的 | imminent danger 迫在眉睫的危险 | The storm is **imminent**. |
| | robe (复现) | /roʊb/ | n. 长袍；浴袍 | bath robe 浴袍 | She put on her **robe**. |
| | extinguish (复现) | /ɪkˈstɪŋɡwɪʃ/ | v. 熄灭；消灭，使破灭 | extinguish a fire 灭火 | Firefighters **extinguished** the blaze. |
| | span (复现) | /spæn/ | n. 一段时间；跨度<br>v. 横跨 | life span 寿命<br>attention span 注意力 | The bridge **spans** the river. |
| | discourse (复现) | /ˈdɪskɔːrs/ | n. 话语，论述；演讲 | public discourse 公众话语 | The internet changed public **discourse**. |
| | stroll (复现) | /stroʊl/ | v./n. 散步，漫步 | take a stroll 散步 | We **strolled** along the beach. |
| | unanimous (复现) | /juˈnænɪməs/ | adj. 一致的，全体同意的 | unanimous decision 一致决定 | The jury reached a **unanimous** verdict. |
| | deteriorate (复现) | /dɪˈtɪriəreɪt/ | v. 恶化，变坏 | deteriorate into 恶化为 | His health began to **deteriorate**. |
| | impose (复现) | /ɪmˈpoʊz/ | v. 强加；征收；推行 | impose a tax on 征税 | Don't **impose** your views. |
| | inherent (复现) | /ɪnˈhɪrənt/ | adj. 固有的，内在的 | be inherent in 固有的 | There are risks **inherent** in investment. |
| | vulgar (复现) | /ˈvʌlɡər/ | adj. 粗俗的，庸俗的 | vulgar language 粗俗语言 | His jokes were **vulgar**. |
| | assess (复现) | /əˈses/ | v. 评估，评定；估价 | assess the damage 评估损失 | Teachers **assess** students' progress. |
| | plagiarism (复现) | /ˈpleɪdʒərɪzəm/ | n. 抄袭，剽窃 | commit plagiarism 剽窃 | The paper was rejected for **plagiarism**. |
| | ebb (复现) | /eb/ | n. 退潮，衰退<br>v. 衰退，减退 | ebb and flow 涨落，兴衰<br>at a low ebb 处于低潮 | His enthusiasm began to **ebb** away. |
| | mischief (复现) | /ˈmɪstʃɪf/ | n. 恶作剧，捣蛋；伤害 | get into mischief 捣蛋 | The children were up to **mischief**. |
| | jargon (复现) | /ˈdʒɑːrɡən/ | n. 行话，专业术语 | legal jargon 法律术语 | The report is full of technical **jargon**. |
| | vicious (复现) | /ˈvɪʃəs/ | adj. 恶毒的，凶残的；剧烈的 | vicious cycle 恶性循环 | He made a **vicious** remark. |
| | irony (复现) | /ˈaɪrəni/ | n. 讽刺，反讽 | the irony is that 讽刺的是 | The **irony** is that he became a teacher. |
| | recede (复现) | /rɪˈsiːd/ | v. 后退，减弱；（头发）变秃 | receding hairline 后退的发际线 | The flood waters **receded**. |
| | flock (复现) | /flɑːk/ | n. 群（羊/鸟）；人群<br>v. 成群前往 | a flock of birds 一群鸟<br>flock to 蜂拥到 | Tourists **flocked** to the beach. |
| | excerpt (复现) | /ˈeksɜːrpt/ | n. 摘录，节选<br>v. 摘录，引用 | excerpt from 从…摘录 | The teacher read an **excerpt**. |
| | fiscal (复现) | /ˈfɪskl/ | adj. 财政的 | fiscal policy 财政政策<br>fiscal year 财政年度 | The government announced **fiscal** measures. |
| | correspondent (复现) | /ˌkɔːrəˈspɑːndənt/ | n. 记者，通讯员；通信者 | foreign correspondent 驻外记者 | He worked as a foreign **correspondent**. |
| | persist | /pərˈsɪst/ | v. 坚持，执意；<br>持续存在 | persist in 坚持<br>persist with 继续坚持<br>persistence n. 坚持<br>persistent adj. 持续的 | If you **persist** in your efforts, you will succeed. （如果你坚持努力，就会成功。）<br>The pain **persisted** for several days. （疼痛持续了好几天。）<br><br>🔍 **近义**：persevere（坚持不懈）/ continue（继续）/ last（持续）· **反义**：give up（放弃）/ stop（停止）· **易混**：persist vs persevere（persevere 偏褒义"锲而不舍"，persist 中性可贬）vs insist（坚持主张）· 词根：per-始终 + sist-站立 → 始终站立→坚持 |
| | buffer | /ˈbʌfər/ | n. 缓冲器；缓冲剂；<br>缓冲区<br>v. 缓冲，减轻 | buffer zone 缓冲区<br>buffer the impact 缓冲冲击<br>buffer stock 缓冲库存 | The trees act as a **buffer** against the wind. （这些树起到防风缓冲作用。）<br>Savings **buffer** you against financial shocks. （储蓄能缓冲财务冲击。）<br><br>🔍 **近义**：cushion（缓冲）/ shield（防护）/ protection（保护）· **反义**：aggravate（加剧）· **易混**：buffer vs suffer（受苦）vs buffer ≠ buffer（≠ buffer vs butter 黄油）· 一词多义：缓冲器 / 缓冲 |
| | abrupt | /əˈbrʌpt/ | adj. 突然的，意外的；<br>唐突的，生硬的 | abrupt change 突变<br>abrupt departure 突然离开<br>abrupt manner 生硬的态度<br>abruptly adv. 突然地 | The meeting came to an **abrupt** end. （会议突然结束。）<br>His **abrupt** manner offended people. （他生硬的态度冒犯了别人。）<br><br>🔍 **近义**：sudden（突然的）/ unexpected（意外的）/ blunt（生硬的）· **反义**：gradual（逐渐的）/ gentle（温和的）· **易混**：abrupt vs corrupt（腐败）vs bankrupt（破产）· 词根：ab-离开 + rupt-断裂 → 突然断裂→突然的 |
| | scrap | /skræp/ | n. 碎片，小块；废料<br>v. 废弃，取消<br>adj. 废弃的 | scrap metal 废金属<br>scrap the plan 放弃计划<br>a scrap of 一点…<br>scrap paper 废纸 | The plane was built from **scrap** metal. （这架飞机是用废金属造的。）<br>They **scrapped** the original plan. （他们废弃了原计划。）<br><br>🔍 **近义**：fragment（碎片）/ waste（废料）/ abandon（放弃）· **反义**：keep（保留）/ preserve（保存）· **易混**：scrap vs scrape（刮擦）vs scrap ≠ scrap（≠ scrap vs strap 带子）· 一词多义：碎片 / 废料 / 废弃 |
| | dump | /dʌmp/ | v. 倾倒，丢弃；<br>倾销；转储<br>n. 垃圾场 | dump waste 倾倒垃圾<br>dump goods 倾销商品<br>dump on 倾倒于<br>garbage dump 垃圾场 | The factory **dumped** waste into the river. （工厂向河里倾倒废物。）<br>The company was accused of **dumping** cheap goods. （该公司被指控倾销廉价商品。）<br><br>🔍 **近义**：discard（丢弃）/ dispose of（处理掉）/ unload（卸下）· **易混**：dump vs bump（碰撞）vs dump ≠ dump（≠ dump vs damp 潮湿的）· 一词多义：倾倒 / 倾销 / 垃圾场 |
| | circumference | /sərˈkʌmfərəns/ | n. 圆周，周长 | the circumference of 圆的周长<br>measure the circumference 测量周长<br>circumference of the earth 地球周长 | The **circumference** of the circle is 2πr. （圆的周长是2πr。）<br>It's about 40,000 km around the earth's **circumference**. （地球周长约4万公里。）<br><br>🔍 **近义**：perimeter（周长）/ boundary（边界）/ outline（轮廓）· **易混**：circumference vs circumstance（环境）vs circumference ≠ circumference（≠ circumference vs circumference ≠ circumference）· 词根：circum-环绕 + fer-带 → 环绕携带的长度→周长 |
| | rigid | /ˈrɪdʒɪd/ | adj. 僵硬的，刚硬的；<br>严格的，死板的 | rigid rules 严格的规定<br>rigid body 刚体<br>rigid attitude 僵硬的态度<br>rigidly adv. 死板地 | The rules are too **rigid** — there's no flexibility. （规定太死板，没有灵活性。）<br>The frame is made of **rigid** steel. （框架由刚性钢材制成。）<br><br>🔍 **近义**：stiff（僵硬的）/ inflexible（不灵活的）/ strict（严格的）· **反义**：flexible（灵活的）/ elastic（有弹性的）· **易混**：rigid vs rigorous（严密的）vs rigid ≠ rigid（≠ rigid vs ridge 山脊）· 词根：rig-僵硬（如 rigor 严格） |
| | district | /ˈdɪstrɪkt/ | n. 地区，区域；<br>行政区 | business district 商业区<br>school district 学区<br>residential district 住宅区<br>district court 地方法院 | She lives in the financial **district**. （她住在金融区。）<br>The school **district** covers three towns. （该学区覆盖三个城镇。）<br><br>🔍 **近义**：area（地区）/ region（区域）/ zone（地带）· **易混**：district vs restrict（限制）vs district ≠ district（≠ district vs distinct 明显的）· 词根：dis-分开 + strict-拉紧 → 分开的区域→行政区 |
| | diagram | /ˈdaɪəɡræm/ | n. 图表，示意图<br>v. 用图表示 | draw a diagram 画图<br>circuit diagram 电路图<br>flow diagram 流程图<br>diagrammatic adj. 图解的 | The teacher drew a **diagram** of the process. （老师画了一张流程示意图。）<br>Please refer to the **diagram** on page 5. （请参考第5页的图表。）<br><br>🔍 **近义**：chart（图表）/ graph（曲线图）/ figure（图）· **反义**：text（文字）· **易混**：diagram vs diagonal（对角线的）vs diagram ≠ diagram（≠ diagram vs diaphragm 隔膜）· 词根：dia-穿过 + gram-写 → 画出来→图表 |
| | intrigue | /ˈɪntriːɡ/ n.<br>/ɪnˈtriːɡ/ v. | n. 阴谋，密谋<br>v. 激起…的兴趣；密谋 | intrigue with 与…密谋<br>political intrigue 政治阴谋<br>be intrigued by 被…吸引<br>intriguing adj. 引人入胜的 | The novel is full of political **intrigue**. （这部小说充满政治阴谋。）<br>She was **intrigued** by the strange message. （她被那条奇怪的信息吸引住了。）<br><br>🔍 **近义**：conspiracy（阴谋）/ scheme（阴谋）/ fascinate（吸引）· **易混**：intrigue vs intrigue ≠ intrigue（≠ intrigue vs intrigue ≠ intrinsic 固有的）· 一词多义：阴谋 / 激起兴趣 |
| | contract | /ˈkɑːntrækt/ n.<br>/kənˈtrækt/ v. | n. 合同，契约<br>v. 订立合同；<br>收缩；感染 | sign a contract 签合同<br>contract with 与…签约<br>contract a disease 染上疾病<br>metal contracts 金属收缩 | She signed a two-year **contract**. （她签了一份两年的合同。）<br>Metal **contracts** when it cools. （金属冷却时收缩。）<br><br>🔍 **近义**：agreement（协议）/ treaty（条约）/ shrink（收缩）· **反义**：expand（膨胀）· **易混**：contract vs contact（联系）vs contrast（对比）· 一词多义：合同 / 收缩 / 感染 |
| 2026-09-04 | cricket (复现) | /ˈkrɪkɪt/ | n. 板球；蟋蟀 | play cricket 打板球<br>not cricket 不公正的 | He is a passionate **cricket** player. |
...
| | alloy (复现) | /ˈælɔɪ/ | n. 合金<br>v. 铸成合金；掺杂 | aluminum alloy 铝合金<br>alloy of copper and zinc 铜锌合金 | Brass is an **alloy** of copper and zinc. |
| | plaster (复现) | /ˈplæstər/ | n. 灰泥；石膏；创可贴<br>v. 涂灰泥；张贴 | plaster cast 石膏绷带<br>plaster the walls 粉刷 | His arm was in a **plaster** cast. |
| | slum (复现) | /slʌm/ | n. 贫民窟，棚户区 | slum area 贫民区 | He grew up in the **slums**. |
| | mug (复现) | /mʌɡ/ | n. 马克杯，大杯<br>v. 行凶抢劫 | coffee mug 咖啡杯<br>be mugged 被抢劫 | She was **mugged** on her way home. |
...
| | flavor (复现) | /ˈfleɪvər/ | n. 风味，味道<br>v. 给…调味 | distinctive flavor 独特风味 | This dish has a rich **flavor**. |
| | resemble (复现) | /rɪˈzembl/ | v. 像，与…相似 | resemble sb/sth 与…相似 | She **resembles** her mother. |
| | consume | /kənˈsuːm/ | v. 消耗，消费；<br>吃光，喝光；吞噬 | consume energy 消耗能量<br>consume resources 消耗资源<br>be consumed with 充满（情绪）<br>consumer n. 消费者 | The car **consumes** a lot of fuel. （这辆车耗油量大。）<br>She was **consumed with** jealousy. （她满心嫉妒。）<br><br>🔍 **近义**：use up（用完）/ devour（吞噬）/ eat（吃）· **反义**：conserve（节约）/ save（节省）· **易混**：consume vs resume（恢复）vs assume（假设）· 词根：con-完全 + sum-拿 → 全部拿走→消耗 |
| | characteristic | /ˌkærəktəˈrɪstɪk/ | n. 特征，特性，特色<br>adj. 典型的，特有的 | characteristic of …的特征<br>unique characteristic 独特特征<br>be characteristic of 是…的典型特征<br>characterize v. 描述特征 | Honesty is a **characteristic** of her personality. （诚实是她性格的一个特征。）<br>This style is **characteristic of** the region. （这种风格是该地区的典型特色。）<br><br>🔍 **近义**：feature（特征）/ trait（特质）/ attribute（属性）· **易混**：characteristic vs character（性格/角色）vs characteristic ≠ characteristic（≠ characteristic vs charismatic 有魅力的）· 词根：character（性格）+ -istic |
| | vicinity | /vəˈsɪnəti/ | n. 附近，邻近地区 | in the vicinity of 在…附近<br>in close vicinity 近在咫尺<br>immediate vicinity 邻近地区 | There is a school **in the vicinity of** our house. （我们家附近有一所学校。）<br>The hotel is **in the vicinity of** the airport. （这家酒店在机场附近。）<br><br>🔍 **近义**：neighborhood（邻近地区）/ surroundings（周围环境）/ proximity（接近）· **易混**：vicinity vs victory（胜利）vs vicinity ≠ vicinity（≠ vicinity vs velocity 速度）· 词根：vicin-邻近 + -ity |
| 2026-09-05 | thread (复现) | /θred/ | n. 线；线索，思路；螺纹<br>v. 穿线于；穿过 | common thread 共同线索<br>lose the thread 失去头绪<br>thread a needle 穿针 | I lost the **thread** of the conversation. |
...
| | consecutive (复现) | /kənˈsekjətɪv/ | adj. 连续的，连贯的 | three consecutive days 连续三天 | It rained for five **consecutive** days. |
| | pneumonia (复现) | /nuːˈmoʊniə/ | n. 肺炎 | catch pneumonia 得肺炎 | He was hospitalized with **pneumonia**. |
| | neutral (复现) | /ˈnuːtrəl/ | adj. 中立的<br>n. 空挡 | remain neutral 保持中立 | Switzerland remained **neutral**. |
...
| 2026-09-15 | reclaim (复现) | /rɪˈkleɪm/ | v. 取回，收回；开垦；回收 | reclaim land 开垦土地<br>reclaim one's property 收回财产 | They **reclaimed** the land from the sea. |
| | denote (复现) | /dɪˈnoʊt/ | v. 表示，指示；意味着 | denote that 表示… | A red light **denotes** danger. |
| | rehearse (复现) | /rɪˈhɜːrs/ | v. 排练，排演；背诵；重复 | rehearse a play 排练戏剧 | The actors **rehearsed** the scene again. |
| | petition (复现) | /pəˈtɪʃn/ | n. 请愿书；申请<br>v. 请愿，正式请求 | sign a petition 签署请愿书<br>petition for 请求 | They **petitioned** the government for change. |
| | veto (复现) | /ˈviːtoʊ/ | v. 否决<br>n. 否决权 | veto a bill 否决议案<br>exercise a veto 行使否决权 | The president **vetoed** the bill. |
