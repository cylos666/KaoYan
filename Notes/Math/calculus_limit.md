...
### 例题21：导数定义判定可导性·含绝对值（2018 数一/二/三）
...
### 例题22：高阶导数·莱布尼茨公式 / 麦克劳林展开（2015 数二）
...
> 📎 **关联文件**：[泰勒展开与等价无穷小](calculus_taylor.md) | [洛必达法则失效](calculus_lhopital.md) | [连续与间断点](calculus_continuous.md) | [返回高等数学目录](calculus.md)
